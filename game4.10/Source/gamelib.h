 ...
 * This file is part of
 , a free game development framework for windows.
 *
...
#define DEFAULT_BG_COLOR	 RGB(33, 44, 69)	// 遊戲畫面預設的背景顏色(黑色)
...
namespace game_framework {
	...
	//class CGameStateChooseLevel;
	//class CGameStateCredit;
